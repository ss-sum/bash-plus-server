...
class InformationController {
    ...
    @ApiResponses(value = [
        ApiResponse(responseCode = "200", description = "OK", content = [Content(schemaProperties = [SchemaProperty(name = "message", schema = Schema(implementation = HostInformationDTO::class))])]),
    ...
    @ApiResponses(value = [
        ApiResponse(responseCode = "200", description = "OK", content = [Content(schemaProperties = [SchemaProperty(name = "message", schema = Schema(implementation = CategoryInformationDTO::class))])]),
        ApiResponse(responseCode = "400", description = "BAD REQUEST", content = [Content(schema = Schema(implementation = ApiExceptionEntity::class))]),
        ApiResponse(responseCode = "500", description = "INTERNAL SERVER ERROR", content = [Content(schema = Schema(implementation = ApiExceptionEntity::class))])
    ])
