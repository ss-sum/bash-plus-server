...
class SearchController {
    ...
    fun searchHost(@PathVariable keyword: String, @RequestParam pageSize: Int, @RequestParam pageNum: Int): ResponseDTO {
        val pageable: Pageable = PageRequest.of(pageNum, pageSize)
    ...
    fun searchCategory(@PathVariable keyword: String, @RequestParam pageSize: Int, @RequestParam pageNum: Int): ResponseDTO {
        val pageable: Pageable = PageRequest.of(pageNum, pageSize)
    ...
    fun searchConference(@PathVariable keyword: String, @RequestParam pageSize: Int, @RequestParam pageNum: Int): ResponseDTO {
        val pageable: Pageable = PageRequest.of(pageNum, pageSize)
